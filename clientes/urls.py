...
from clientes.views import estados, cidades, bairros,gerenciar_endereco, detalhar_propriedade, add_cidade_popup, add_estado_popup, add_bairro_popup
urlpatterns = [
        ...
        path('add_estado_popup/', add_estado_popup, name='add_estado_popup'),
        path('add_cidade_popup/', add_cidade_popup, name='add_cidade_popup'),
        path('add_bairro_popup/', add_bairro_popup, name='add_bairro_popup'),
